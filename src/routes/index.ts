...
import ictServicesRoutes from "../modules/ictRegister/services.routes";
import ictSubcontractingRoutes from "../modules/ictRegister/subcontracting.routes";
...
import itRisikoBerechtigungenRoutes from "../modules/itRisiko/berechtigungen.routes";
import itRisikoProjekteRoutes from "../modules/itRisiko/projekte.routes";
import itRisikoAenderungenRoutes from "../modules/itRisiko/aenderungen.routes";
...
router.use("/ict-register/arrangements/:arrangementId/services", ictServicesRoutes);
router.use("/ict-register/arrangements/:arrangementId/subcontracting", ictSubcontractingRoutes);
...
router.use("/it-risiko/berechtigungen", itRisikoBerechtigungenRoutes);
router.use("/it-risiko/projekte", itRisikoProjekteRoutes);
router.use("/it-risiko/aenderungen", itRisikoAenderungenRoutes);
