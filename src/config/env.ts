...
// JWTs sign every session in a regulated product -- presence alone isn't enough, a short secret
// is brute-forceable. 32 chars matches the dev value in .env.example.
