...
- Risikomanagement (MaRisk AT 4) und IT-Risikomanagement/BAIT: eine erste Fassung ist da
  ...
  `/risikomanagement/modelle`, inkl. UI-Panels auf `/risikomanagement`. Offene Fragen (u. a. kein
  eigener ISB-Login im MVP) siehe `Risikomanagement_BAIT_MVP_Spezifikation.md`.
